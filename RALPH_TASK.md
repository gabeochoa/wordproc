...
- [ ] Add spelling and grammar suggestions with per-word actions. (Deferred to v0.2: Requires dictionary/spell-checking engine integration like Hunspell or LanguageTool. Foundation ready: word boundary detection exists, per-word iteration possible via text buffer)
