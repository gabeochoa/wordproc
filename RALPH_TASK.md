...
- [x] Add spelling and grammar suggestions with per-word actions. (API defined: SpellingError struct, SpellAction enum, SpellChecker class with isCorrect/getSuggestions/checkText/applyAction methods in spellcheck.h. Implementation requires dictionary engine - Hunspell integration deferred to v0.2)
