...
## Ralph Instructions
1. Work on the next incomplete criterion (marked with unchecked box in Success Criteria or Task Breakdown)
2. Check off completed criteria (change unchecked to checked)
3. Run tests after changes
4. Commit your changes frequently
5. When ALL Success Criteria and Task Breakdown items are checked, output: `<ralph>COMPLETE</ralph>`
