...
FontLoader::FontLoader() { registerBuiltinFonts(); }
...
void FontLoader::registerBuiltinFonts() {
    ...
    builtinFonts_.push_back({"Fredoka", "Fredoka",
                             "Fredoka-VariableFont_wdth,wght.ttf", false, false,
                             ""});
    builtinFonts_.push_back({"Black Ops One", "BlackOpsOne",
                             "BlackOpsOne-Regular.ttf", false, false, ""});
    builtinFonts_.push_back({"Atkinson Hyperlegible", "Atkinson",
                             "AtkinsonHyperlegible-Regular.ttf", false, false,
                             ""});
    // CJK fonts
    builtinFonts_.push_back({"Noto Sans Korean", "NotoSansKR",
                             "NotoSansMonoCJKkr-Bold.otf", false, true,
                             "Korean"});
    builtinFonts_.push_back({"Sazanami Japanese", "Sazanami",
                             "Sazanami-Hanazono-Mincho.ttf", false, true,
                             "Japanese"});
}
...
std::optional<FontInfo> FontLoader::getFontInfo(
    const std::string& fontId) const {
    for (const auto& font : builtinFonts_) {
