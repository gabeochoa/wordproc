...
const char* presetName(Preset preset) {
  switch (preset) {
    case Preset::SystemDefault: return "System Default";
    case Preset::WindowsCtrl: return "Windows (Ctrl)";
    case Preset::MacOSCmd: return "macOS (Cmd)";
...
// - Cmd+Arrow for line/document navigation (Ctrl in raylib, mapped as Cmd substitute)
