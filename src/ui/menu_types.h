...
inline std::vector<MenuData> createMenuBarData() {
    ...
    fileMenu.label = "File";
    fileMenu.items = {
        {"New", "Ctrl+N", true, false},  {"Open...", "Ctrl+O", true, false},
        {"Save", "Ctrl+S", true, false}, {"Save As...", "", true, false},
    ...
    formatMenu.items = {{"Bold", "Ctrl+B", true, false},
    ...
    MenuData helpMenu;
    helpMenu.label = "Help";
    helpMenu.items = {{"About Wordproc", "", true, false}};
