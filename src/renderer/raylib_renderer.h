...
class RaylibRenderer : public IRenderer {
   public:
    ...
    // Frame management
    void beginFrame() override { raylib::BeginDrawing(); }

    void endFrame() override { raylib::EndDrawing(); }
    ...
    void drawRectLines(const Rect& rect, float thickness,
                       const Color& color) override {
        raylib::DrawRectangleLinesEx(toRaylib(rect), thickness,
                                     toRaylib(color));
    }
    ...
    // Screen info
    int getScreenWidth() override { return raylib::GetScreenWidth(); }

    int getScreenHeight() override { return raylib::GetScreenHeight(); }
...
inline Color fromRaylib(raylib::Color c) { return Color{c.r, c.g, c.b, c.a}; }
